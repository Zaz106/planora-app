  ...
  return (
    <section className="auth-hero">
      ...
      <div className="auth-overlay">
        <div className="auth-card" role="dialog" aria-labelledby="login-title" aria-describedby="login-subtitle">
          <header className="auth-header">
            <Logo size={48} className="auth-logo" />
            <h1 id="login-title" className="auth-title">Welcome Back!</h1>
            <p id="login-subtitle" className="auth-subtitle">Continue your learning journey with bite-sized lessons and daily streaks.</p>
          </header>
          ...
          <form onSubmit={onSubmit} className="auth-form">
            ...
            <div className="auth-row">
              <label className="remember">
                <input type="checkbox" id="remember" className="checkbox-input" style={{display: 'none'}} />
              ...
              <Link href="/forgot" className="auth-link small">Forgot password?</Link>
            </div>
          ...
          <p className="auth-alt">Don’t have an account? <Link href="/signup" className="auth-link">Create one</Link></p>
